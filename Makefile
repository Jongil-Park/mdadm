...
CC=$(OCTEON_ROOT)/tools/bin/mips64-octeon-linux-gnu-gcc 
PATH:=$(OCTEON_ROOT)/tools/bin:$(PATH)
CROSS_COMPILE=$(OCTEON_ROOT)/tools/bin/mips64-octeon-linux-gnu-
...
all : mdadm mdadm.conf.man mdadm.man
